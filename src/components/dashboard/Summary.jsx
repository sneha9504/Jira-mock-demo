...
If due date or priority is unknown, use placeholders like 'unknown' or infer reasonably. Data: ${rawText.slice(0, 2000)}`;
  ...
  return (
 <div className="p-4 sm:p-8 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 min-h-screen flex flex-col items-center justify-start">
  <h1 className="text-2xl sm:text-3xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight mb-4 sm:mb-6">AI Project Summary</h1>
  <button
    onClick={generateSummary}
    disabled={loading}
    className="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 flex items-center justify-center gap-2 text-sm sm:text-base"
  >
    {loading ? (
      <>
        Generating...
  ...
  {summary && (
    <div className="mt-4 sm:mt-6 w-full max-w-2xl p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 whitespace-pre-line text-gray-800 dark:text-gray-200 leading-relaxed">
